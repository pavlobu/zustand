...
In [jest](https://jestjs.io/), you can create a `__mocks__/zustand.js` and place the code in that file. If your app is using `@pavlobu/zustand/vanilla` instead of `@pavlobu/zustand`, then you'll have to place the above code in `__mocks__/zustand/vanilla.js`.
